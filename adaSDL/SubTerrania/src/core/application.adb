...
package body Application is
   ...
   funciton To_Dim (V : Float) return SDL.Natural_Dimension is 
   begin
      if V <= 0.0 then
...
begin
   ...
   procedure Update is
      ...
      Prev_X : Float := T.Element.all.X;
      Prev_Y : Float := T.Element.all.Y;
   begin
